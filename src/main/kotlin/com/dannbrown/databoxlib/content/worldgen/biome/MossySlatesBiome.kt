...
object MossySlatesBiome : AbstractBiome() {
  ...
  override fun createBiome(
    ...
    val generationSettings = BiomeGenerationSettings.Builder(placedFeatures, caveGetter)
      // raw generation
      .addFeature(GenerationStep.Decoration.RAW_GENERATION, ProjectPlacedFeatures.STONE_BLOBS_PLACED)
      .addFeature(GenerationStep.Decoration.RAW_GENERATION, ProjectPlacedFeatures.BASALT_BLOBS_PLACED)
      .addFeature(GenerationStep.Decoration.RAW_GENERATION, ProjectPlacedFeatures.BOULDER_COLUMNS_PLACED)
      // lakes
      ...
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ProjectPlacedFeatures.PATCH_BERRY_BUSH_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ProjectPlacedFeatures.DRY_PATCHES_NOISE_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ProjectPlacedFeatures.MOSS_CARPET_NOISE_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ProjectPlacedFeatures.PATCH_DRY_SHRUBS_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ProjectPlacedFeatures.PATCH_OCOTILLO_PLACED)
