package com.dannbrown.databoxlib.content.worldgen.dimension
...
object PlanetZeroDimension : AbstractDimension() {
  override val dimensionId: String = "planet_zero"
  override val LEVEL = ResourceKey.create(Registries.DIMENSION, LibUtils.resourceLocation(dimensionId))
  override val LEVEL_STEM = ResourceKey.create(Registries.LEVEL_STEM, LibUtils.resourceLocation(dimensionId))
  override val DIMENSION_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE, LibUtils.resourceLocation(dimensionId))
  override val NOISE_SETTINGS = ResourceKey.create(Registries.NOISE_SETTINGS, LibUtils.resourceLocation(dimensionId))
  ...
  override val SKYBOX = PlanetCodec.SkyBoxProperties()
    ...
    .setSkyObjects(listOf(
      PlanetCodec.SkyObject(
        LibUtils.resourceLocation("textures/sky/sun.png"),
        true,
      ...
      PlanetCodec.SkyObject(
        LibUtils.resourceLocation("textures/sky/moon.png"),
        false,
        PlanetCodec.RenderTypeProperty.DYNAMIC,
      ...
      PlanetCodec.SkyObject(
        LibUtils.resourceLocation("textures/sky/light.png"),
        true,
        PlanetCodec.RenderTypeProperty.DYNAMIC,
        Vector3f(-180.0f, -90.0f, 0.0f),
        24.0f,
  ...
  override fun bootstrapType(context: BootstapContext<DimensionType>) {
    context.register(
      DIMENSION_TYPE, DimensionType(
        ...
        LibUtils.resourceLocation(dimensionId),  // DimensionRenderInfo
        0.0f,  // ambient light
  ...
  override fun bootstrapNoise(context: BootstapContext<NoiseGeneratorSettings>) {
    ...
    val densityShiftX = ProjectDensityFunctions.getFunction(functions, ProjectDensityFunctions.SHIFT_X)
    val densityShiftZ = ProjectDensityFunctions.getFunction(functions, ProjectDensityFunctions.SHIFT_Z)
    val endBase3dNoise = ProjectDensityFunctions.getFunction(functions, ProjectDensityFunctions.BASE_3D_NOISE_END)
                ...
                SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.sequence(
                    ...
                    SurfaceRules.ifTrue(
                      ...
                      SurfaceRules.ifTrue(
                        SurfaceRules.hole(),
                        SurfaceRules.state(ProjectBlocks.RED_SANDSTONE_PEBBLES.get()
                          .defaultBlockState())
                      )
                    ),
                    SurfaceRules.ifTrue(
                ...
                SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.sequence(
                    ...
                    SurfaceRules.ifTrue(
                      ...
                      SurfaceRules.ifTrue(
                        SurfaceRules.hole(),
                        SurfaceRules.state(ProjectBlocks.SANDSTONE_PEBBLES.get()
                          .defaultBlockState())
                      )
                    ),
                    SurfaceRules.ifTrue(
                      SurfaceRules.stoneDepthCheck(0, false, CaveSurface.FLOOR),
                      SurfaceRules.state(ProjectBlocks.SILT.get()
                        .defaultBlockState())
                    ),
                    SurfaceRules.ifTrue(
                      SurfaceRules.stoneDepthCheck(0, true, CaveSurface.FLOOR),
                ...
                SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.sequence(
                    ...
                    SurfaceRules.ifTrue(
                      ...
                      SurfaceRules.ifTrue(
                        SurfaceRules.hole(),
                        SurfaceRules.state(ProjectBlocks.ROSEATE_SANDSTONE_PEBBLES.get()
                          .defaultBlockState())
                      )
                    ),
                    ...
                    SurfaceRules.ifTrue(
                      SurfaceRules.stoneDepthCheck(0, true, CaveSurface.FLOOR),
                      SurfaceRules.state(ProjectBlocks.ROSEATE_GRAINS.get()
                        .defaultBlockState())
                    ),
                    // roseate sandstone
                    SurfaceRules.ifTrue(
                      SurfaceRules.stoneDepthCheck(0, true, 30, CaveSurface.FLOOR),
                      SurfaceRules.state(ProjectBlocks.ROSEATE_FAMILY.SANDSTONE!!.get()
                        .defaultBlockState())
                    ),
                  )
                ),
...
//                    ),
                    ...
                    SurfaceRules.ifTrue(
                      SurfaceRules.stoneDepthCheck(0, true, CaveSurface.FLOOR),
                      SurfaceRules.state(ProjectBlocks.COBBLED_BROWN_SLATE.get()
                        .defaultBlockState())
                    ),
                    // roseate sandstone
                    SurfaceRules.ifTrue(
