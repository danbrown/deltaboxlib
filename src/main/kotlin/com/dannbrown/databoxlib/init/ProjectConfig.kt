...
object ProjectConfig {
  ...
  class Server {
    ...
    // The mass a antimatter can lift
    @JsonSchema(description = "Amount of mass in kg a antimatter can absorb")
    var massPerAntimatter = 5000.0

    // The mass a Mass Nullifier block can negate per block present (default is the Netherite Block mass, 89680.0)
    var massNullifierNegatePerBlock = 89680.0
