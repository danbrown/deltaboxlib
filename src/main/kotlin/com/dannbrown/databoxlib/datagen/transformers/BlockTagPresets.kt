...
object BlockTagPresets {
  ...
  fun casingBlockTags(): Pair<Array<TagKey<Block>>, Array<TagKey<Item>>> {
    return Pair(arrayOf(AllTags.AllBlockTags.CASING.tag, AllTags.AllBlockTags.WRENCH_PICKUP.tag), arrayOf(AllTags.AllItemTags.CASING.tag))
  }

  fun scaffoldingBlockTags(): Pair<Array<TagKey<Block>>, Array<TagKey<Item>>> {
    return Pair(arrayOf(BlockTags.CLIMBABLE, AllTags.AllBlockTags.WRENCH_PICKUP.tag), arrayOf())
  }

  fun barsBlockTags(): Pair<Array<TagKey<Block>>, Array<TagKey<Item>>> {
    return Pair(arrayOf(AllTags.AllBlockTags.WRENCH_PICKUP.tag, AllTags.AllBlockTags.FAN_TRANSPARENT.tag), arrayOf())
  }
  ...
  fun metalTrapdoorTags(): Pair<Array<TagKey<Block>>, Array<TagKey<Item>>> {
    return Pair(arrayOf(BlockTags.TRAPDOORS, AllTags.AllBlockTags.WRENCH_PICKUP.tag), arrayOf(ItemTags.TRAPDOORS))
  }

  fun stickerTags(): Pair<Array<TagKey<Block>>, Array<TagKey<Item>>> {
    val databoxlibStickerBlockTag = LibTags.databoxlibBlockTag("stickers")
    val databoxlibStickerItemTag = LibTags.databoxlibItemTag("stickers")
    return Pair(arrayOf(databoxlibStickerBlockTag, AllTags.AllBlockTags.WRENCH_PICKUP.tag), arrayOf(databoxlibStickerItemTag))
  }
