...
class RenewablesRecipeGen(generator: DataGenerator) : ProjectRecipeGen(generator) {
  override val recipeName = "Renewables"
  val MOON_REGOLITH_FROM_GRAVEL = create("moon_regolith_from_gravel") { b ->
    b
      .mixing { b ->
        b
          .require(Blocks.GRAVEL)
          .require(ProjectBlocks.MOON_REGOLITH.get())
          .output(ProjectBlocks.MOON_REGOLITH.get(), 2)
      }
  }
