...
object ProjectDispenserBehaviors {
  val WATER_GEL_DISPENSER = registerThrowableBehavior({ ProjectItems.WATER_GEL_BUBBLE.get() }, WaterGelBubbleProjectileEntity::class)
  val LAVA_GEL_DISPENSER = registerThrowableBehavior({ ProjectItems.LAVA_GEL_BUBBLE.get() }, LavaGelBubbleProjectileEntity::class)
  val ANTIMATTER_DISPENSER = registerBlockPlaceRemoveBehavior({ ProjectBlocks.ANTIMATTER_BLOCK.get() }, AntimatterBlock::class)
