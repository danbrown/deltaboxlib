package com.dannbrown.databoxlib.compat.alexsmobs
...
object AlexsMobsPlugin : AbstractModPlugin(AlexsMobs.MODID, ProjectContent.isAlexsMobsLoaded) {
  // biome tags
  ...
  override fun bootstrapBiomeModifiers(context: BootstapContext<BiomeModifier>) {
    ...
    val isRedSandArches: HolderSet<Biome> = biomeLookup.getOrThrow(ProjectTags.BIOME.IS_RED_SAND_ARCHES)
    val isMossySlates: HolderSet<Biome> = biomeLookup.getOrThrow(ProjectTags.BIOME.IS_MOSSY_SLATES)
    val isScrapWastelands: HolderSet<Biome> = biomeLookup.getOrThrow(ProjectTags.BIOME.IS_SCRAP_WASTELANDS)
    val isRoseateDesert: HolderSet<Biome> = biomeLookup.getOrThrow(ProjectTags.BIOME.IS_ROSEATE_DESERT)
    // -----
    val isMoon: HolderSet<Biome> = biomeLookup.getOrThrow(ProjectTags.BIOME.IS_MOON)
