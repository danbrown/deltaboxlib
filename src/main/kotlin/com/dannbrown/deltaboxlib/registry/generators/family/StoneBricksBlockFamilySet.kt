 ...
 */
class StoneBricksBlockFamilySet(
  ...
  private val mainBlock: Supplier<out ItemLike>,
  private val polishedBlock: Supplier<out Block>?,
): AbstractBlockFamilySet() {
  init {
    val MATERIAL_TAG = LibTags.modItemTag(generator.registrate.modid, _name + "_blocks")
    val bricksMaterial = polishedBlock ?: mainBlock
