...
class PalmFoliagePlacer(pRadius: IntProvider, pOffset: IntProvider) : FoliagePlacer(pRadius, pOffset) {
  ...
  companion object {
    val CODEC: com.mojang.serialization.Codec<PalmFoliagePlacer> =
      RecordCodecBuilder.create { placer: RecordCodecBuilder.Instance<PalmFoliagePlacer> ->
        foliagePlacerParts(placer).apply(placer) { pRadius: IntProvider, pOffset: IntProvider ->
          PalmFoliagePlacer(
            pRadius,
            pOffset
          )
