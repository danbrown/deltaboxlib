...
//      }
  ...
  enum class Type(
    ...
    fun block(): Block {
      return if (this.open) DeltaboxBlocks.EYE_BLOSSOM.get() else DeltaboxBlocks.CLOSED_EYE_BLOSSOM.get()
    }
  ...
  override fun newBlockEntity(p0: BlockPos, p1: BlockState): BlockEntity? {
    return DeltaboxBlockEntities.EYEBLOSSOM_BLOCK_ENTITY.get().create(p0, p1)
  }
