...
import com.dannbrown.deltaboxlib.init.DeltaboxModelLayers
...
class EyeBlossomRenderer(pContext: BlockEntityRendererProvider.Context) : BlockEntityRenderer<EyeBlossomBlockEntity> {
  private val shell: ModelPart = pContext.bakeLayer(DeltaboxModelLayers.EYE_BLOSSOM)
  ...
  override fun render(
    ...
    if (pBlockEntity.blockState.`is`(DeltaboxBlocks.EYE_BLOSSOM.get())) {
      pPoseStack.pushPose()
