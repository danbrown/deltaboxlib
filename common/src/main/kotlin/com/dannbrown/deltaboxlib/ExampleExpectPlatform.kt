...
object ExampleExpectPlatform {
     ...
     *
     * Example:
     * Expect: com.dannbrown.deltaboxlib.ExampleExpectPlatform#getConfigDirectory()
     * Actual Fabric: com.dannbrown.deltaboxlib.fabric.ExampleExpectPlatformImpl#getConfigDirectory()
     * Actual Forge: com.dannbrown.deltaboxlib.forge.ExampleExpectPlatformImpl#getConfigDirectory()
     *
     *
