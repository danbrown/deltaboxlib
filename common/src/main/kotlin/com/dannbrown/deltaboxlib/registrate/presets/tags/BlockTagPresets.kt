...
object BlockTagPresets {
  ...
  fun woodenTrapdoorTags(): Pair<List<TagKey<Block>>, List<TagKey<Item>>> {
    return Pair(
      listOf(BlockTags.WOODEN_TRAPDOORS, BlockTags.TRAPDOORS),
      listOf(ItemTags.WOODEN_TRAPDOORS, ItemTags.TRAPDOORS)
    )
  }
  ...
  fun fenceTags(isWooden: Boolean): Pair<List<TagKey<Block>>, List<TagKey<Item>>> {
    return if (isWooden) Pair(
      listOf(BlockTags.FENCES, BlockTags.WOODEN_FENCES),
      listOf(ItemTags.FENCES, ItemTags.WOODEN_FENCES)
    )
  ...
  fun pressurePlateTags(isWooden: Boolean): Pair<List<TagKey<Block>>, List<TagKey<Item>>> {
    return if (isWooden) Pair(
      listOf(BlockTags.PRESSURE_PLATES, BlockTags.WOODEN_PRESSURE_PLATES),
      listOf(ItemTags.WOODEN_PRESSURE_PLATES)
    )
  ...
  fun buttonTags(isWooden: Boolean): Pair<List<TagKey<Block>>, List<TagKey<Item>>> {
    return if (isWooden) Pair(
      listOf(BlockTags.BUTTONS, BlockTags.WOODEN_BUTTONS),
      listOf(ItemTags.WOODEN_BUTTONS, ItemTags.BUTTONS)
    )
  ...
  fun doorTags(isWooden: Boolean): Pair<List<TagKey<Block>>, List<TagKey<Item>>> {
    return if (isWooden) Pair(
      listOf(BlockTags.DOORS, BlockTags.WOODEN_DOORS),
      listOf(ItemTags.DOORS, ItemTags.WOODEN_DOORS)
    )
