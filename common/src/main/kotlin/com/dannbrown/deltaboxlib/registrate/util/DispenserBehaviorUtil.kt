...
object DispenserBehaviorUtil {
  fun <T : ThrowableItemProjectile> registerThrowableBehavior(
    item: Supplier<ItemLike>,
    projectileClass: KClass<T>
  ...
  fun <T : Block> registerBlockPlaceRemoveBehavior(
